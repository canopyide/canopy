export const SEL = {
  ...
  flavor: {
    ...
    selectorListbox: '[data-testid="flavor-selector-listbox"]',
    flavorRow: "#agents-flavors [data-testid]",
    autoBadge: "[data-testid='flavor-badge-auto']",
    customBadge: "[data-testid='flavor-badge-custom']",
    editButton: '[aria-label^="Edit"]',
    deleteButton: '[aria-label^="Delete"]',
    duplicateButton: '[aria-label^="Duplicate"]',
    toolbarChevron: '[aria-label^="Choose"][aria-label$="flavor"]',
    ...
    vanillaOption: '[data-testid="flavor-option-vanilla"]',
    customFlavorOption: '[data-testid="flavor-selector-listbox"] [role="option"]',
  },
} as const;
