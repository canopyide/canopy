...
module.exports = async function () {
  ...
  return {
    ...
    mac: {
      ...
      x64ArchFiles:
        "Contents/Resources/app.asar.unpacked/node_modules/{node-pty/build/Release/**,win-job-object/bin/**,@parcel/watcher/bin/darwin-arm64-*/watcher.node,@parcel/watcher-darwin-*/watcher.node}",
