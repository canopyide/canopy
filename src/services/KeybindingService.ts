...
const DEFAULT_KEYBINDINGS: KeybindingConfig[] = [
  ...
  },
  {
    ...
    scope: "global",
    priority: 0,
    description: "Minimize focused terminal (deprecated, use terminal.toggleDock)",
    category: "Terminal",
  },
  {
    ...
    scope: "global",
    priority: 0,
    description: "Minimize all terminals (deprecated, use terminal.toggleDockAll)",
    category: "Terminal",
  },
  {
    ...
    scope: "global",
    priority: 0,
    description: "Restore focused terminal (deprecated, use terminal.toggleDock)",
    category: "Terminal",
  },
  {
    ...
    scope: "global",
    priority: 0,
    description: "Restore all terminals (deprecated, use terminal.toggleDockAll)",
    category: "Terminal",
  },
  {
    ...
    scope: "global",
    priority: 0,
    description: "Open new terminal palette (deprecated, use panel.palette)",
    category: "Terminal",
  },
  {
    ...
    scope: "global",
    priority: 0,
    description: "Open terminal palette (deprecated, use nav.quickSwitcher)",
    category: "Terminal",
  },
];
