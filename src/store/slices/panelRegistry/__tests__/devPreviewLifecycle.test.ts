...
describe("dev-preview lifecycle integration", () => {
  ...
  it("stops dev-preview runtime when panel is removed", () => {
    ...
    usePanelStore.getState().removePanel("dev-panel-1");
  ...
  it("stops dev-preview runtime when panel is trashed", () => {
    ...
    usePanelStore.getState().trashPanel("dev-panel-2");
  ...
  it("stops dev-preview runtimes when trashing a panel group", () => {
    ...
    usePanelStore.getState().trashPanelGroup("dev-panel-3");
  ...
  it("stops all dev-preview runtimes when trashing a mixed multi-dev group", () => {
    ...
    usePanelStore.getState().trashPanelGroup("dev-panel-a");
