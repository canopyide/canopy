...
export const SETTINGS_SEARCH_INDEX: SettingsSearchEntry[] = [
  ...
  {
    id: "terminal-skip-close-confirm",
    tab: "terminal",
    scope: "global",
    tabLabel: "Panel Grid",
    subtab: "input",
    ...
    description: "Close working agents immediately without showing the confirmation dialog",
    keywords: [
      "close",
      "confirm",
      "confirmation",
  ...
  // Daintree Assistant
  {
    id: "tab-nav-assistant",
    tab: "assistant",
    scope: "global",
    tabLabel: "Daintree Assistant",
    section: "Settings Navigation",
    title: "Daintree Assistant",
    description: "Preferred model, tools, security, and audit logging for the help assistant",
    keywords: [
      "assistant",
      "daintree",
      "help",
  ...
  },
  {
    ...
    description: "Model used when the help assistant launches",
    keywords: ["assistant", "model", "claude", "fast", "preferred", "help", "haiku", "sonnet"],
  },
  {
    ...
    description: "Let the assistant search Daintree documentation and changelog while answering",
  ...
  },
  {
    ...
    keywords: ["assistant", "permissions", "skip", "dangerously", "confirm", "security", "bypass"],
  },
  {
    ...
    keywords: ["assistant", "audit", "log", "retention", "privacy", "history", "logging", "days"],
  },
  {
