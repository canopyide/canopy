...
export const BUILT_IN_APP_SCHEMES: AppColorScheme[] = [
  ...
  },
  {
    ...
    tokens: createCanopyTokens("light", {
      ...
      "surface-sidebar": "#DDD4BF",
      "surface-panel": "#FFFCF7",
      "surface-panel-elevated": "#FFFFFF",
      "surface-grid": "#E4DCCA",
      "text-primary": "#2D2418",
      "text-secondary": "color-mix(in oklab, #2D2418 72%, #F3EFE4)",
      "text-muted": "#7A6E5E",
      "text-inverse": "#F3EFE4",
      "border-default": "#C8BDA8",
      "border-subtle": "#D8CFBE",
      "border-strong": "#B5A890",
      "border-divider": "#E5DDD0",
      "accent-primary": "#3F9366",
      "accent-foreground": "#08140E",
      ...
      "terminal-selection": "rgba(63, 147, 102, 0.18)",
      "terminal-red": "#B03530",
