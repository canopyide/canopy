...
export const BUILT_IN_APP_SCHEMES: AppColorScheme[] = [
  ...
  },
  {
    ...
    tokens: createCanopyTokens("dark", {
      ...
      "overlay-emphasis": "rgba(200,180,150,0.06)",
      // Status
  ...
  },
  {
    ...
    tokens: createCanopyTokens("light", {
      ...
      "search-highlight-background": "rgba(27,133,97,0.12)",
      ...
      "recipe-shadow-floating": "0 20px 44px rgba(20,40,25,0.06), 0 8px 18px rgba(20,40,25,0.10)",
