...
export const BUILT_IN_APP_SCHEMES: AppColorScheme[] = [
  ...
  },
  {
    ...
    tokens: createCanopyTokens("light", {
      ...
      "surface-grid": "#e2e8f0",
      // Text — slate scale for crisp readability
      "text-primary": "#0f172a",
      ...
      // Accent — vivid Bondi Blue (darkened slightly for WCAG 4.5:1)
      "accent-primary": "#0080A0",
      "accent-foreground": "#ffffff",
      // Status — vivid, saturated
      ...
      "activity-working": "#059669",
      "activity-waiting": "#d97706",
      // GitHub — light-mode palette
      "github-open": "#2da44e",
      "github-merged": "#8250df",
      "github-closed": "#cf222e",
      "github-draft": "#6e7781",
      // Terminal — vivid saturated (WCAG 4.5:1 on panel & canvas)
      ...
      "terminal-bright-green": "#065f46",
      "terminal-bright-yellow": "#92400e",
      "terminal-bright-blue": "#1e40af",
      "terminal-bright-magenta": "#6d28d9",
      "terminal-bright-cyan": "#155e75",
      "terminal-bright-white": "#020617",
      // Syntax — vivid, clear
      ...
      "category-blue": "oklch(0.55 0.16 250)",
      "category-purple": "oklch(0.55 0.16 310)",
      "category-cyan": "oklch(0.55 0.14 215)",
      "category-green": "oklch(0.55 0.15 145)",
      "category-amber": "oklch(0.60 0.16 75)",
      "category-orange": "oklch(0.58 0.17 45)",
      "category-teal": "oklch(0.55 0.13 185)",
      "category-indigo": "oklch(0.52 0.15 275)",
      "category-rose": "oklch(0.55 0.16 5)",
      "category-pink": "oklch(0.58 0.15 340)",
      "category-violet": "oklch(0.55 0.15 295)",
      "category-slate": "oklch(0.50 0.04 240)",
    }),
  },
  {
    id: "fiordland",
    ...
    tokens: createCanopyTokens("dark", {
      ...
      "text-muted": "#7A8790",
      "text-inverse": "#070D12",
      "border-default": "#152232",
      "accent-primary": "#3F9366",
      "status-success": "#5F8B6D",
      "status-warning": "#C59A4E",
      "status-danger": "#E04055",
      "status-info": "#7B8C96",
      "activity-active": "#2DD4BF",
      "activity-idle": "#3D4E5C",
      "activity-working": "#2DD4BF",
      "activity-waiting": "#94A3B8",
      ...
      "terminal-blue": "#6B9CD6",
      "terminal-magenta": "#B382B8",
      "terminal-cyan": "#58AFB6",
      "terminal-bright-red": "#E2838F",
      "terminal-bright-green": "#81C2A5",
      "terminal-bright-yellow": "#DEC08C",
      "terminal-bright-blue": "#8DB9EE",
      "terminal-bright-magenta": "#CCA1D0",
      "terminal-bright-cyan": "#74CAD1",
      "terminal-bright-white": "#D4E3EF",
      "syntax-comment": "#565F89",
      "syntax-punctuation": "#C2CED6",
      "syntax-number": "#B4BEFE",
      "syntax-string": "#4FD6BE",
  ...
  },
  {
    ...
    tokens: createCanopyTokens("dark", {
      ...
      "syntax-quote": "#9BA8B0",
      "syntax-chip": "#5AAA8A",
      "shadow-color": "rgba(16, 14, 10, 0.55)",
      "focus-ring": "rgba(255, 255, 255, 0.18)",
      "category-blue": "oklch(0.7 0.13 250)",
      "category-purple": "oklch(0.7 0.13 310)",
      "category-cyan": "oklch(0.72 0.11 215)",
  ...
  },
  {
    ...
    tokens: createCanopyTokens("dark", {
      ...
      "activity-working": "#22c55e",
      "activity-waiting": "#C89A3A",
      "terminal-selection": "#A3573B",
      "terminal-red": "#C7504A",
      ...
      "syntax-number": "#D4A046",
      "syntax-string": "#F7C242",
      "syntax-operator": "#C4AA84",
      "syntax-keyword": "#E06268",
      "syntax-function": "#A6BA65",
      "syntax-link": "#6EA89A",
      "syntax-quote": "#A09880",
      "syntax-chip": "#7DB5A8",
      "shadow-color": "rgba(30, 20, 12, 0.5)",
  ...
  },
  {
    ...
    tokens: createCanopyTokens("dark", {
      ...
      "shadow-color": "rgba(20, 16, 10, 0.55)",
  ...
  },
  {
    ...
    tokens: createCanopyTokens("dark", {
      ...
      "shadow-color": "rgba(22, 12, 8, 0.55)",
  ...
  },
  {
    ...
    builtin: true,
    tokens: createCanopyTokens("light", {
      "surface-canvas": "#ECF1F6",
      "surface-sidebar": "#DDE6EE",
      "surface-panel": "#F5F8FB",
      "surface-panel-elevated": "#FFFFFF",
      "surface-grid": "#CDD9E3",
      "text-primary": "#2B3540",
      "text-secondary": "color-mix(in oklab, #2B3540 72%, #ECF1F6)",
      "text-muted": "#576C7D",
      "text-inverse": "#0D1A24",
      ...
      "activity-idle": "#758595",
      "activity-working": "oklch(0.58 0.16 250)",
      "activity-waiting": "oklch(0.60 0.15 65)",
      "terminal-selection": "#D0E4EE",
      "terminal-red": "#A3454E",
      "terminal-green": "#367550",
      "terminal-yellow": "#7A5C1E",
      "terminal-blue": "#456C94",
      "terminal-magenta": "#7B5C8C",
      "terminal-cyan": "#387580",
      "terminal-bright-red": "#AD4C54",
      "terminal-bright-green": "#3D7E52",
      "terminal-bright-yellow": "#87651F",
      "terminal-bright-blue": "#4C769A",
      "terminal-bright-magenta": "#7E5E8E",
      "terminal-bright-cyan": "#357078",
      "terminal-bright-white": "#0D1A24",
      "syntax-keyword": "#795293",
      "syntax-string": "#B34060",
