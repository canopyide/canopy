...
export const BUILT_IN_APP_SCHEMES: AppColorScheme[] = [
  ...
  },
  {
    ...
    builtin: true,
    tokens: createCanopyTokens("dark", {
      "surface-canvas": "#1C0F0B",
      "surface-sidebar": "#150B08",
      "surface-panel": "#201410",
      "surface-panel-elevated": "#2E1E18",
      "surface-grid": "#100806",
      "text-primary": "#E5E0D8",
      "text-secondary": "color-mix(in oklab, #E5E0D8 65%, #1C0F0B)",
      "text-muted": "#73828A",
      "text-inverse": "#1C0F0B",
      "border-default": "#352018",
      "accent-primary": "#3F9366",
      ...
      "status-info": "#6A8090",
      "activity-active": "#22c55e",
      "activity-idle": "#4A3530",
      "activity-working": "#22c55e",
      "activity-waiting": "#D4913E",
      "terminal-selection": "#2E1A10",
      "terminal-red": "#D95E4E",
  ...
  },
  {
    ...
    tokens: createCanopyTokens("dark", {
      ...
      "surface-panel": "#1E1512",
      "surface-panel-elevated": "#2B1D19",
      "surface-grid": "#0F0B09",
      "text-primary": "#D4C5B8",
      "text-secondary": "color-mix(in oklab, #D4C5B8 65%, #1A1210)",
      "text-muted": "#7A6A60",
      "text-inverse": "#1A1210",
      "border-default": "#2B1D19",
      "accent-primary": "#3F9366",
      "status-success": "#5F8B6D",
      "status-warning": "#C59A4E",
      ...
      "terminal-selection": "#2B1D28",
      "terminal-red": "#A65142",
      "terminal-green": "#6D7A4D",
      "terminal-yellow": "#C2984A",
      "terminal-blue": "#5E7A8C",
      "terminal-magenta": "#926A7A",
      "terminal-cyan": "#608E81",
      "terminal-bright-red": "#D16954",
      "terminal-bright-green": "#91A368",
      "terminal-bright-yellow": "#D4AA5E",
      "terminal-bright-blue": "#7DA0B8",
      "terminal-bright-magenta": "#B88A9C",
      "terminal-bright-cyan": "#85B8A9",
      "terminal-bright-white": "#D4C5B8",
      "syntax-comment": "#4E6A59",
  ...
  },
  {
    ...
    tokens: createCanopyTokens("light", {
      ...
      "surface-sidebar": "#EBEAE6",
      "surface-panel": "#FAFAF8",
      "surface-panel-elevated": "#FFFFFF",
      "surface-grid": "#E3E2DE",
      "text-primary": "#3A3431",
      "text-secondary": "color-mix(in oklab, #3A3431 72%, #F4F4F2)",
      "text-muted": "#6B6560",
      "text-inverse": "#10161b",
      "border-default": "#D5D3CE",
      "accent-primary": "#3F9366",
      "accent-foreground": "#08140e",
  ...
  },
  {
    ...
    tokens: createCanopyTokens("light", {
      ...
      "terminal-white": "#9B8D7A",
      "terminal-bright-black": "#A89A8A",
      "terminal-bright-white": "#4A3F35",
      "terminal-red": "#B03530",
  ...
  },
  {
    ...
    builtin: true,
    tokens: createCanopyTokens("light", {
      "surface-canvas": "#F4F7F9",
      "surface-sidebar": "#E8EDF2",
      "surface-panel": "#FAFCFD",
      "surface-panel-elevated": "#FFFFFF",
      "surface-grid": "#DCE4EB",
      "text-primary": "#2B3540",
      "text-secondary": "color-mix(in oklab, #2B3540 72%, #F4F7F9)",
      "text-muted": "#6B8295",
      "text-inverse": "#0D1A24",
      "border-default": "#C8D4DC",
      "accent-primary": "#3F9366",
      "accent-foreground": "#08140e",
      "status-success": "#2F6F4F",
      ...
      "terminal-red": "#B42318",
      "terminal-green": "#1F8F58",
      "terminal-yellow": "#A37526",
      "terminal-blue": "#2E5E82",
      "terminal-magenta": "#795293",
      "terminal-cyan": "#006A71",
      "terminal-bright-red": "#DC2626",
      "terminal-bright-green": "#16A34A",
      "terminal-bright-yellow": "#CA8A04",
      "terminal-bright-blue": "#3B82F6",
