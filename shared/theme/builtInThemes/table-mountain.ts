...
export const theme: BuiltInThemeSource = {
  ...
  extensions: {
    ...
    "settings-nav-active-bg": "rgba(168,69,110,0.18)",
    "settings-nav-active-shadow":
      "0 1px 2px rgba(60,48,38,0.08), inset 0 0 0 1px rgba(168,69,110,0.22)",
    ...
    "toolbar-project-bg":
      "linear-gradient(180deg, rgba(168,69,110,0.04), rgba(60,48,38,0.05)), linear-gradient(135deg, #EDE7E0, #E3DBD3)",
