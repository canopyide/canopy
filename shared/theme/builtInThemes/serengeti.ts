...
export const theme: BuiltInThemeSource = {
  ...
  tokens: {
    ...
    "overlay-soft": "rgba(162,130,36,0.06)",
    "overlay-strong": "rgba(44,33,15,0.08)",
    "overlay-subtle": "rgba(162,130,36,0.04)",
  ...
  extensions: {
    ...
    "settings-nav-active-bg": "rgba(162,130,36,0.20)",
    "settings-nav-active-shadow":
      "0 1px 3px rgba(44,33,15,0.07), inset 0 0 0 1px rgba(162,130,36,0.25)",
