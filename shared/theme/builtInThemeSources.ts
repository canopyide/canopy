...
export const BUILT_IN_THEME_SOURCES: BuiltInThemeSource[] = [
  {
    ...
    tokens: {
      ...
      "scrollbar-thumb": "#555C58",
      "scrollbar-thumb-hover": "color-mix(in oklab, #555C58 85%, #E1E5E2)",
    ...
    extensions: {
      ...
      "pulse-skeleton-gradient": "linear-gradient(90deg, #2D302F 25%, #363A38 50%, #2D302F 75%)",
      "settings-kbd-bg": "#19191A",
      "settings-search-bg": "#19191A",
      "settings-search-muted": "#9AA29E",
  ...
  },
  {
    ...
    tokens: {
      ...
      "scrollbar-thumb": "#758A9E",
      "scrollbar-thumb-hover": "color-mix(in oklab, #758A9E 85%, #0D1621)",
      ...
      "shadow-ambient": "0 1px 2px rgba(13, 22, 33, 0.08)",
      "shadow-color": "rgba(13, 22, 33, 0.12)",
      "shadow-dialog": "0 4px 12px rgba(13, 22, 33, 0.12), 0 2px 4px rgba(13, 22, 33, 0.08)",
      "shadow-floating": "0 4px 12px rgba(13, 22, 33, 0.12), 0 2px 4px rgba(13, 22, 33, 0.08)",
    ...
    extensions: {
      "pulse-before-bg": "#E3EEF6",
      "pulse-card-shadow": "0 1px 3px rgba(13,22,33,0.08)",
      "pulse-control-hover-bg": "rgba(13, 22, 33, 0.03)",
      "pulse-empty-bg": "#F0F6FC",
      "pulse-missed-bg": "rgba(214,53,46,0.10)",
      "pulse-skeleton-gradient": "linear-gradient(90deg, #E8F1F9 25%, #F0F6FC 50%, #E8F1F9 75%)",
      "settings-nav-active-bg": "rgba(0,135,161,0.10)",
      "settings-nav-active-shadow":
        "0 1px 2px rgba(13,22,33,0.08), inset 0 0 0 1px rgba(0,135,161,0.20)",
      "sidebar-action-hover-bg": "rgba(13,22,33,0.05)",
      "sidebar-active-shadow": "none",
      "sidebar-hover-bg": "rgba(13,22,33,0.03)",
      "toolbar-agent-hover-bg": "#FFFFFF",
      "toolbar-control-hover-bg": "#FFFFFF",
      "toolbar-control-hover-fg": "#0087A1",
      "toolbar-control-hover-shadow": "0 1px 2px rgba(68,84,104,0.10)",
      "toolbar-divider": "rgba(176,203,224,0.4)",
      "toolbar-pill-radius": "0.75rem",
      "toolbar-project-bg": "linear-gradient(180deg, #FFFFFF, #EEF5FC)",
      "toolbar-project-border": "#C5DDF2",
      "toolbar-project-chip-bg": "#F5FAFE",
      "toolbar-project-chip-border": "#C5DDF2",
      "toolbar-project-shadow":
        "0 1px 2px rgba(68,84,104,0.08), inset 0 1px 0 rgba(255,255,255,0.75)",
      "toolbar-shadow": "inset 0 -1px 0 rgba(255,255,255,0.65)",
      "toolbar-stats-bg": "#FFFFFF",
      "toolbar-stats-border": "#C5DDF2",
      "toolbar-stats-divider": "#C5DDF2",
      "toolbar-stats-hover-bg": "#F5FAFE",
      "toolbar-stats-shadow": "0 1px 2px rgba(68,84,104,0.06)",
      "worktree-section-hover-bg": "rgba(13, 22, 33, 0.05)",
    },
  },
  {
    id: "table-mountain",
